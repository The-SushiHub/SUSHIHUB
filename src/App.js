    ...
    async function fetchData() {
      try {
        const [cartResponse, favoritesResponse, itemsResponse] = await Promise.all([
          axios.get('https://62ac1c85bd0e5d29af1ad2e1.mockapi.io/cart'),
          axios.get('https://62ac1c85bd0e5d29af1ad2e1.mockapi.io/favorites'),
          axios.get('https://62ac1c85bd0e5d29af1ad2e1.mockapi.io/items'),
        ]);
...
//        setCartItems((prev) => [...prev, obj]); // 50 & 52 lines works inproperly
